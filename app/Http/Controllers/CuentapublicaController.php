...
class CuentapublicaController extends Controller
{
    ...
    public function licitaciones()
    {
        ...
        $icatech_ictp_002_2023 = [
            'ACTA DE APERTURAS DE PROPUESTAS TÉCNICAS Y ECONÓMICAS' => 'licitaciones_/adquisiciones/AAPTE_2_2023.pdf',
            'ACTA DE FALLO' => 'licitaciones_/adquisiciones/ADF_2_2023.pdf',
        ];
        $icatech_ictp_003_2023 = [
            'ACTA DE APERTURAS DE PROPUESTAS TÉCNICAS Y ECONÓMICAS' => 'licitaciones_/adquisiciones/AAPTE_3_2023.pdf',
            'ACTA DE FALLO' => 'licitaciones_/adquisiciones/ADF_3_2023.pdf',
        ];
        ...
        return view('pages.licitaciones',
            [
                ...
                'icatech_ictp_002_2023' => $icatech_ictp_002_2023,
                'icatech_ictp_003_2023' => $icatech_ictp_003_2023,
            ]
        );
    }
    ...
    public function avisosprivacidad()
    {
        ...
        $avisos_integrales2021 =array(
            ...
            'Recursos Materiales (registro de proveedores)' => 'avisos_de_privacidad/integral/14_AVISO_INTEGRAL_REC_MAT_REGISTRO_DE_PROVEEDORES.pdf',
            'Recursos Materiales (resguardo de mobiliarios)' => 'avisos_de_privacidad/integral/15_AVISO_INTEGRAL_REC_MAT_RESGUARDO_DE_MOBILIARIOS.pdf',
            'Recursos Materiales (registro de visitantes)' => 'avisos_de_privacidad/integral/16_AVISO_INTEGRAL_REC_MAT_REGISTRO_DE_VISITANTES.pdf',
            'Recursos Materiales (cámaras de video)' => 'avisos_de_privacidad/integral/17_AVISO_INTEGRAL_REC_MAT_CAMARAS_VIDEO.pdf',
            'Técnica Académica (certificación escolar)' => 'avisos_de_privacidad/integral/18_AVISO_INTEGRAL_TEC_ACAD_CONTROL_ESCOLAR.pdf',
            'Técnica Académica (validación personal docente)' => 'avisos_de_privacidad/integral/19_AVISO_INTEGRAL_TEC_ACAD_VALIDACION_PERSONAL_DOCENTE.pdf',
            'Delegación (contrato de instructores)' => 'avisos_de_privacidad/integral/20_AVISO_INTEGRAL_DELEGACION_CONTRATO_INSTRUCTORES.pdf',
            'Planeación (junta directiva)' => 'avisos_de_privacidad/integral/21_AVISO_INTEGRAL_PLANEACION_JUNTA_DIRECTIVA.pdf',
            'Vinculación Gubernamental (firma de convenios)' => 'avisos_de_privacidad/integral/22_AVISO_INTEGRAL_VINC_GUBERNAM_FIRMA_CONVENIOS.pdf',
            'Vinculación competitividad (firma de convenios)' => 'avisos_de_privacidad/integral/23_AVISO_INTEGRAL_VINC_COMPET_FIRMA_CONVENIOS.pdf',
            'Vinculación Competitividad (seguimiento a egresados)' => 'avisos_de_privacidad/integral/24_AVISO_INTEGRAL_VINC_COMPET_SEGUIMIENTO_A_EGRESADOS.pdf',
            'Vinculación Social y Empresarial (firma de convenios)' => 'avisos_de_privacidad/integral/25_AVISO_INTEGRAL_VINC_SOCIAL_Y_EMPRES_FIRMA_CONVENIOS.pdf',
            'Comisaria Pública' => 'avisos_de_privacidad/integral/26_AVISO_INTEGRAL_COMISARIA.pdf',
        );

        $avisos_simplificados2021 =array(
            'Dirección General Control de Accesos' => 'avisos_de_privacidad/simplificado/1_AVISO_SIMPLIFICADO_DIRECC_GRAL_CONTROL_DE_ACCESO.pdf',
            'Coordinación de Archivos' => 'avisos_de_privacidad/simplificado/2_AVISO_SIMPLIFICADO_COORDINACION_DE_ARCHIVOS.pdf',
            'ICATECH Cursos no Presenciales' => 'avisos_de_privacidad/simplificado/3_AVISO_SIMPLIFICADO_ICATECH_CURSOS_NO_PRESENCIALES.pdf',
            'Informática, Firma Electrónica' => 'avisos_de_privacidad/simplificado/4_AVISO_SIMPLIFICADO_INFORMATICA_FIRMA_ELECT.pdf',
            'Mercadotecnia, Atención en Redes' => 'avisos_de_privacidad/simplificado/5_AVISO_SIMPLIFICADO_MERCADOTECNIA_ATENCION_EN_REDES.pdf',
            'Mercadotecnia, Uso de Imagen' => 'avisos_de_privacidad/simplificado/6_AVISO_SIMPLIFICADO_MERCADOTECNIA_USO_DE_IMAGEN.pdf',
            'Unidad Jurídica, Procedimientos Administrativos' => 'avisos_de_privacidad/simplificado/7_AVISO_SIMPLIFICADO_UNIDAD_JURIDICA_PROCEDIMIENTOS_ADMVOS.pdf',
            'Transparencia, Solicitudes de Información' => 'avisos_de_privacidad/simplificado/8_AVISO_SIMPLIFICADO_TRANSPARENCIA_SOLICITUDES_DE_INFORMACION.pdf',
            'Transparencia Derechos Arco' => 'avisos_de_privacidad/simplificado/9_AVISO_SIMPLIFICADO_TRANSPARENCIA_DERECHOS_ARCO.pdf',
            'Recursos Financieros (CFDI)' => 'avisos_de_privacidad/simplificado/10_AVISO_SIMPLIFICADO_REC_FINANC_CFDI.pdf',
            'Recursos Humanos (nomina)' => 'avisos_de_privacidad/simplificado/11_AVISO_SIMPLIFICADO_REC_HUM_NOMINA.pdf',
            'Recursos Humanos (expediente único del personal)' => 'avisos_de_privacidad/simplificado/12_AVISO_SIMPLIFICADO_REC_HUM_EXPEDIENTE_UNICO_PERS.pdf',
            'Recursos Humanos (sistema de registro de asistencia)' => 'avisos_de_privacidad/simplificado/13_AVISO_SIMPLIFICADO_REC_HUM_REGISTRO_ASISTENCIA.pdf',
            'Recursos Materiales (registro de proveedores)' => 'avisos_de_privacidad/simplificado/14_AVISO_SIMPLIFICADO_REC_MAT_REGISTRO_DE_PROVEEDORES.pdf',
            'Recursos Materiales (resguardo de mobiliarios)' => 'avisos_de_privacidad/simplificado/15_AVISO_SIMPLIFICADO_REC_MAT_RESGUARDO_DE_MOBILIARIO.pdf',
            'Recursos Materiales (registro de visitantes)' => 'avisos_de_privacidad/simplificado/16_AVISO_SIMPLIFICADO_REC_MAT_REGISTRO_DE_VISITANTES.pdf',
            'Recursos Materiales (cámaras de video)' => 'avisos_de_privacidad/simplificado/17_AVISO_SIMPLIFICADO_REC_MAT_CAMARAS_VIDEO.pdf',
            'Técnica Académica (certificación escolar)' => 'avisos_de_privacidad/simplificado/18_AVISO_SIMPLIFICADO_TEC_ACAD_CONTROL_ESCOLAR.pdf',
            'Técnica Académica (validación personal docente)' => 'avisos_de_privacidad/simplificado/19_AVISO_SIMPLIFICADO_TEC_ACAD_VALIDACION_PERSONAL_DOCENTE.pdf',
            'Delegación (contrato de instructores)' => 'avisos_de_privacidad/simplificado/20_AVISO_SIMPLIFICADO_DELEGACION_CONTRATO_INSTRUCTORES.pdf',
            'Planeación (junta directiva)' => 'avisos_de_privacidad/simplificado/21_AVISO_SIMPLIFICADO_PLANEACION_JUNTA_DIRECTIVA.pdf',
            'Vinculación Gubernamental (firma de convenios)' => 'avisos_de_privacidad/simplificado/22_AVISO_SIMPLIFICADO_VINC_COMPET_FIRMA_CONVENIOS.pdf',
            'Vinculación competitividad (firma de convenios)' => 'avisos_de_privacidad/simplificado/23_AVISO_SIMPLIFICADO_VINC_GUBERNAM_FIRMA_CONVENIOS.pdf',
            'Vinculación Competitividad (seguimiento a egresados)' => 'avisos_de_privacidad/simplificado/24_AVISO_SIMPLIFICADO_VINC_COMPET_SEGUIMIENTO_A_EGRESADOS.pdf',
            'Vinculación Social y Empresarial (firma de convenios)' => 'avisos_de_privacidad/simplificado/25_AVISO_SIMPLIFICADO_VINC_SOCIAL_Y_EMPRES_FIRMA_CONVENIOS.pdf',
            'Comisaria Pública' => 'avisos_de_privacidad/simplificado/26_AVISO_SIMPLIFICADO_COMISARIA.pdf',
        );
        $bprincipal = $this->getBanner('banner_principal');
