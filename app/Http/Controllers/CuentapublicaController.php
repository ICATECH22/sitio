...
class CuentapublicaController extends Controller
{
    ...
    public function licitaciones()
    {
        $icatech_ictp_001_2024 = [
            ...
            'ACTA DE FALLO' => 'licitaciones_/adquisiciones/ACTA_FALLO_1_2024.pdf',
        ];
    ...
    public function sevac()
    {
        ...
        $primtrim2023 = [
            'Estado Analítico de la Deuda y Otros Pasivos' => 'sevac_/2023/1t/estado_analitico_de_la_deuda_y_otros_pasivos.pdf',
            'Estado Analítico del Activo' => 'sevac_/2023/1t/estado_analitico_del_activo.pdf',
            'Estado de Actividades' => 'sevac_/2023/1t/estado_de_actividades.pdf',
            'Estado de Cambios en la Situación Financiera' => 'sevac_/2023/1t/estado_de_cambios_en_la_situacion_financiera.pdf',
            'Estado de Flujos de Efectivo' => 'sevac_/2023/1t/estado_de_flujo_de_efectivo.pdf',
            'Estado de Situación Financiera' => 'sevac_/2023/1t/estado_de_situacion_financiera.pdf',
            'Estado de Variación en la Hacienda Pública' => 'sevac_/2023/1t/estado_de_variacion_de_la_hacienda_publica.pdf',
            'Informe sobre Pasivos Contingentes' => 'sevac_/2023/1t/informe_sobre_pasivos_contingentes.pdf',
            'Inventario de Bienes Inmuebles' => 'sevac_/2023/1t/inventario_de_bienes_inmuebles.pdf',
            'Inventario de Bienes Muebles' => 'sevac_/2023/1t/inventario_de_bienes_muebles.pdf',
            'Montos Pagados por Ayudas y Subsidios' => 'sevac_/2023/1t/montos_pagados_por_ayudas_subsidios.pdf',
        ...
        $cuartrim2023 = [
            'Estado Analítico de la Deuda y Otros Pasivos' => 'sevac_/2023/4t/estado_analitico_deuda_otros_pasivos.pdf',
            'Estado Analítico del Activo' => 'sevac_/2023/4t/estado_analitico_activo.pdf',
            'Estado de Actividades' => 'sevac_/2023/4t/estado_actividades.pdf',
            'Estado de Cambios en la Situación Financiera' => 'sevac_/2023/4t/estado_cambios_situacion_financiera.pdf',
            'Estado de Flujos de Efectivo' => 'sevac_/2023/4t/estado_flujo_efectivo.pdf',
            'Estado de Situación Financiera' => 'sevac_/2023/4t/estado_situacion_financiera.pdf',
            'Estado de Variación en la Hacienda Pública' => 'sevac_/2023/4t/estado_variacion_hacienda_publica.pdf',
            'Informe sobre Pasivos Contingentes' => 'sevac_/2023/4t/informe_sobre_pasivos_contingentes.pdf',
         ...
         $segtrim2024 = [
            'Estado de Actividades' => 'sevac_/2024/2t/estado_actividades.pdf',
            'Estado Analítico de la Deuda y Otros Pasivos' => 'sevac_/2024/2t/estado_analitico_de_deuda_otrospasivos.pdf',
            'Nota a los Estados Financieros' => 'sevac_/2024/2t/notas_alos_estados_financieros.pdf',
            'Montos Pagados por Ayudas y Subsidios' => 'sevac_/2024/2t/montos_pagados_ayudassubsidios.pdf',
            'Inventario de Bienes Muebles' => 'sevac_/2024/2t/inventario_bienes_muebles.pdf',
            'Inventario de Bienes Inmuebles' => 'sevac_/2024/2t/inventario_bienes_inmuebles.pdf',
            'Informe sobre Pasivos Contingentes' => 'sevac_/2024/2t/informe_sobrepasivos_contingentes.pdf',
            'Estado de Variación en la Hacienda Pública' => 'sevac_/2024/2t/estado_variacion_enhacienda_publica.pdf',
            'Estado de Situación Financiera' => 'sevac_/2024/2t/estado_situacion_financiera.pdf',
            'Estado de Flujos de Efectivo' => 'sevac_/2024/2t/estado_flujo_de_efectivo.pdf',
            'Estado de Cambios en la Situación Financiera' => 'sevac_/2024/2t/estado_cambios_situacion_financiera.pdf',
    ...
    public function avisosprivacidad()
    {
        ...
        $avisos_integrales2021 = array(
            ...
            'Aviso Integral de Transparencia Buzón Digital' => 'avisos_privacidad/integral/AVISO_INTEGRAL_DE_TRANSPARENCIA_BUZON_DIGITAL.pdf',
            'Informática, Firma Electrónica' => 'avisos_privacidad/integral/4_AVISO_INTEGRAL_INFORMATICA_FIRMA_ELECT.pdf',
            'Mercadotecnia, Atención en Redes' => 'avisos_privacidad/integral/5_AVISO_INTEGRAL_MERCADOTECNIA_ATENCION_EN_REDES.pdf',
            'Mercadotecnia, Uso de Imagen' => 'avisos_privacidad/integral/6_AVISO_INTEGRAL_MERCADOTECNIA_USO_DE_IMAGEN.pdf',
            'Unidad Jurídica, Procedimientos Administrativos' => 'avisos_privacidad/integral/7_AVISO_INTEGRAL_UNIDAD_JURIDICA_PROCEDIMIENTOS_ADMVOS.pdf',
            'Transparencia, Solicitudes de Información' => 'avisos_privacidad/integral/8_AVISO_INTEGRAL_TRANSPARENCIA_SOLICITUDES_DE_INFORMACION.pdf',
            'Transparencia Derechos Arco' => 'avisos_privacidad/integral/9_AVISO_INTEGRAL_TRANSPARENCIA_DERECHOS_ARCO.pdf',
            'Recursos Financieros (CFDI)' => 'avisos_privacidad/integral/10_AVISO_INTEGRAL_REC_FINANC_CFDI.pdf',
            'Recursos Humanos (nomina)' => 'avisos_privacidad/integral/11_AVISO_INTEGRAL_REC_HUM_NOMINA.pdf',
            'Recursos Humanos (expediente único del personal)' => 'avisos_privacidad/integral/12_AVISO_INTEGRAL_REC_HUM_EXPEDIENTE_UNICO_PERS.pdf',
            'Recursos Humanos (sistema de registro de asistencia)' => 'avisos_privacidad/integral/13_AVISO_INTEGRAL_REC_HUM_REGISTRO_ASISTENCIA.pdf',
            'Recursos Materiales (registro de proveedores)' => 'avisos_privacidad/integral/14_AVISO_INTEGRAL_REC_MAT_REGISTRO_DE_PROVEEDORES.pdf',
            'Recursos Materiales (resguardo de mobiliarios)' => 'avisos_privacidad/integral/15_AVISO_INTEGRAL_REC_MAT_RESGUARDO_DE_MOBILIARIOS.pdf',
            'Recursos Materiales (registro de visitantes)' => 'avisos_privacidad/integral/16_AVISO_INTEGRAL_REC_MAT_REGISTRO_DE_VISITANTES.pdf',
            'Recursos Materiales (cámaras de video)' => 'avisos_privacidad/integral/17_AVISO_INTEGRAL_REC_MAT_CAMARAS_VIDEO.pdf',
            'Técnica Académica (certificación escolar)' => 'avisos_privacidad/integral/18_AVISO_INTEGRAL_TEC_ACAD_CONTROL_ESCOLAR.pdf',
            'Técnica Académica (validación personal docente)' => 'avisos_privacidad/integral/19_AVISO_INTEGRAL_TEC_ACAD_VALIDACION_PERSONAL_DOCENTE.pdf',
            'Delegación (contrato de instructores)' => 'avisos_privacidad/integral/20_AVISO_INTEGRAL_DELEGACION_CONTRATO_INSTRUCTORES.pdf',
            'Planeación (junta directiva)' => 'avisos_privacidad/integral/21_AVISO_INTEGRAL_PLANEACION_JUNTA_DIRECTIVA.pdf',
            'Vinculación Gubernamental (firma de convenios)' => 'avisos_privacidad/integral/22_AVISO_INTEGRAL_VINC_GUBERNAM_FIRMA_CONVENIOS.pdf',
            'Vinculación competitividad (firma de convenios)' => 'avisos_privacidad/integral/23_AVISO_INTEGRAL_VINC_COMPET_FIRMA_CONVENIOS.pdf',
            'Vinculación Competitividad (seguimiento a egresados)' => 'avisos_privacidad/integral/24_AVISO_INTEGRAL_VINC_COMPET_SEGUIMIENTO_A_EGRESADOS.pdf',
            'Vinculación Social y Empresarial (firma de convenios)' => 'avisos_privacidad/integral/25_AVISO_INTEGRAL_VINC_SOCIAL_Y_EMPRES_FIRMA_CONVENIOS.pdf',
        ...
        $avisos_simplificados2021 = array(
            ...
            'Aviso Simplificado de Transparencia Buzón Digital' => 'avisos_privacidad/simplificado/AVISO_SIMPLIFICADO_TRANSPARENCIA_BUZON_DIGITAL.pdf',
            'Informática, Firma Electrónica' => 'avisos_privacidad/simplificado/4_AVISO_SIMPLIFICADO_INFORMATICA_FIRMA_ELECT.pdf',
            'Mercadotecnia, Atención en Redes' => 'avisos_privacidad/simplificado/5_AVISO_SIMPLIFICADO_MERCADOTECNIA_ATENCION_EN_REDES.pdf',
            'Mercadotecnia, Uso de Imagen' => 'avisos_privacidad/simplificado/6_AVISO_SIMPLIFICADO_MERCADOTECNIA_USO_DE_IMAGEN.pdf',
            'Unidad Jurídica, Procedimientos Administrativos' => 'avisos_privacidad/simplificado/7_AVISO_SIMPLIFICADO_UNIDAD_JURIDICA_PROCEDIMIENTOS_ADMVOS.pdf',
            'Transparencia, Solicitudes de Información' => 'avisos_privacidad/simplificado/8_AVISO_SIMPLIFICADO_TRANSPARENCIA_SOLICITUDES_DE_INFORMACION.pdf',
            'Transparencia Derechos Arco' => 'avisos_privacidad/simplificado/9_AVISO_SIMPLIFICADO_TRANSPARENCIA_DERECHOS_ARCO.pdf',
            'Recursos Financieros (CFDI)' => 'avisos_privacidad/simplificado/10_AVISO_SIMPLIFICADO_REC_FINANC_CFDI.pdf',
            'Recursos Humanos (nomina)' => 'avisos_privacidad/simplificado/11_AVISO_SIMPLIFICADO_REC_HUM_NOMINA.pdf',
            'Recursos Humanos (expediente único del personal)' => 'avisos_privacidad/simplificado/12_AVISO_SIMPLIFICADO_REC_HUM_EXPEDIENTE_UNICO_PERS.pdf',
            'Recursos Humanos (sistema de registro de asistencia)' => 'avisos_privacidad/simplificado/13_AVISO_SIMPLIFICADO_REC_HUM_REGISTRO_ASISTENCIA.pdf',
            'Recursos Materiales (registro de proveedores)' => 'avisos_privacidad/simplificado/14_AVISO_SIMPLIFICADO_REC_MAT_REGISTRO_DE_PROVEEDORES.pdf',
            'Recursos Materiales (resguardo de mobiliarios)' => 'avisos_privacidad/simplificado/15_AVISO_SIMPLIFICADO_REC_MAT_RESGUARDO_DE_MOBILIARIO.pdf',
            'Recursos Materiales (registro de visitantes)' => 'avisos_privacidad/simplificado/16_AVISO_SIMPLIFICADO_REC_MAT_REGISTRO_DE_VISITANTES.pdf',
            'Recursos Materiales (cámaras de video)' => 'avisos_privacidad/simplificado/17_AVISO_SIMPLIFICADO_REC_MAT_CAMARAS_VIDEO.pdf',
            'Técnica Académica (certificación escolar)' => 'avisos_privacidad/simplificado/18_AVISO_SIMPLIFICADO_TEC_ACAD_CONTROL_ESCOLAR.pdf',
            'Técnica Académica (validación personal docente)' => 'avisos_privacidad/simplificado/19_AVISO_SIMPLIFICADO_TEC_ACAD_VALIDACION_PERSONAL_DOCENTE.pdf',
            'Delegación (contrato de instructores)' => 'avisos_privacidad/simplificado/20_AVISO_SIMPLIFICADO_DELEGACION_CONTRATO_INSTRUCTORES.pdf',
            'Planeación (junta directiva)' => 'avisos_privacidad/simplificado/21_AVISO_SIMPLIFICADO_PLANEACION_JUNTA_DIRECTIVA.pdf',
            'Vinculación Gubernamental (firma de convenios)' => 'avisos_privacidad/simplificado/22_AVISO_SIMPLIFICADO_VINC_COMPET_FIRMA_CONVENIOS.pdf',
            'Vinculación competitividad (firma de convenios)' => 'avisos_privacidad/simplificado/23_AVISO_SIMPLIFICADO_VINC_GUBERNAM_FIRMA_CONVENIOS.pdf',
            'Vinculación Competitividad (seguimiento a egresados)' => 'avisos_privacidad/simplificado/24_AVISO_SIMPLIFICADO_VINC_COMPET_SEGUIMIENTO_A_EGRESADOS.pdf',
