...
class IntegridadController extends Controller
{
    ...
    protected function getcondigoconducta(){
        $array_codigo_conducta = array(
            'Código de Conducta ICATECH' => 'codigos_conducta/CODIGO_CONDUCTA_APROBADO_2023.pdf',
        );
        $bprincipal = $this->getBanner('banner_principal');
    ...
    protected function getpronunciamiento(){
        $array_cero_tolerancia = [
            'Pronunciamiento Cero Tolerancia a las Conductas de Hostigamiento Sexual y Acoso Sexual 2024' => 'codigos_conducta/pronunciamiento_cero_tolerancia_a_las_conductas_2024.pdf',
    ...
    protected function getinformeanualactividades()
    {
        $array_informe_anual = array(
            ...
            'Informe Anual de Actividades 2023' => 'codigos_conducta/informe_anual_de_actividades_2023.pdf',
        );
        $bprincipal = $this->getBanner('banner_principal');
    ...
    protected function getplananualtrabajo()
    {
        $bprincipal = $this->getBanner('banner_principal');
        $array_plan_anual = [
            'Programa Anual de Trabajo 2024' => 'codigos_conducta/PROGRAMA_ANUAL_DE_TRABAJO_2024.pdf',
            'Programa Anual de Trabajo 2023' => 'codigos_conducta/PROGRAMA_ANUAL_DE_TRABAJO_2023.pdf',
        ];
