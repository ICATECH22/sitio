...
<body>
    ...
    @include('red_conocer.component.breadcumb', ['breadcrumb' => __('Empresarios')])
    <!-- ##### Breadcumb Area End ##### -->
            ...
            <div class="row">
                <div class="col-12">
                    <div class="section-heading text-center mx-auto wow fadeInUp" data-wow-delay="300ms">
                        <h3>Certificaciones EC0127 y EC1415</h3>
                    </div>
                </div>
            </div>
            <div class="row">
                ...
                <div class="col-12 col-lg-6">
                    <div class="single-top-popular-course d-flex align-items-center flex-wrap mb-30 wow fadeInUp"
                        ...
                        <div class="popular-course-content">
                            ...
                            <p style="text-align: justify;">Estándar de competencia dirigido a personas que deban contar
                                con conocimientos, habilidades, destrezas y actitudes para las personas que desempeñan
                                las funciones de ventas en pequeños negocios.</p>
