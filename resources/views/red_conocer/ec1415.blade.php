...
<body>
    ...
    @include('red_conocer.component.breadcumb', ['breadcrumb' => __('Certificación EC1415')])
    <!-- ##### Breadcumb Area End ##### -->
    <br><br><br>
    ...
    <div class="popular-course-details-area wow fadeInUp" data-wow-delay="300ms">
        <div class="single-top-popular-course d-flex align-items-center flex-wrap">
            <div class="popular-course-content">
                <h5 style="text-align: justify;">Administración y venta en pequeños negocios y/o establecimientos</h5>
                <span>EC1415</span>
                ...
                <ul class="nav nav-tabs justify-content-center" id="myTab" role="tablist">
                    <li class="nav-item">
                        <a class="nav-link" id="tab--1" data-toggle="tab" href="#tab1" role="tab"
                            aria-controls="tab1" aria-selected="false">CERTIFICACIÓN EC1415 ante Conocer</a>
                    </li>
                    <li class="nav-item">
