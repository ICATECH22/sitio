...
@section('contenido')
    ...
    <div class="container-xl">
        <section class="container g-pt-25">
            ...
            <div class="container">
                <img src="{{ asset('Imagenes_Pagina/aviso_de_privacidad.jpg') }}" class="img-responsive" width="100%"
                    alig="center">
            </div>
            <br>
            ...
            <br>
            <p><b>
                    <h5>AVISOS DE PRIVACIDAD INTEGRALES</h5>
                </b></p>
            {{-- carta --}}
            <div class="card rounded-0 g-brd-none">
                <div id="accordion-07-heading-01" class="u-accordion__header g-pa-0" role="tab">
                    <h5 class="mb-0 g-font-size-default g-font-weight-700 g-pa-20a mb-0">
                        <a class="collapsed d-flex g-color-main g-text-underline--none--hover" href="#accordion-07-body-01"
                            data-toggle="collapse" data-parent="#accordion-07" aria-expanded="false"
                ...
                <div id="accordion-07-body-01" class="collapse" role="tabpanel" aria-labelledby="accordion-07-heading-02"
            ...
            {{-- carta END --}}
            <p><b>
                    <h5>AVISOS DE PRIVACIDAD SIMPLIFICADOS</h5>
                </b></p>
            {{-- carta --}}
            <div class="card rounded-0 g-brd-none">
                <div id="accordion-07-heading-02" class="u-accordion__header g-pa-0" role="tab">
                    <h5 class="mb-0 g-font-size-default g-font-weight-700 g-pa-20a mb-0">
                        <a class="collapsed d-flex g-color-main g-text-underline--none--hover" href="#accordion-07-body-02"
                            data-toggle="collapse" data-parent="#accordion-07" aria-expanded="false"
